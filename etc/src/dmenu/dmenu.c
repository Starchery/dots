...
enum { SchemeNorm, SchemeSel, SchemeOut, SchemeMid, SchemeMidHighlight, SchemeNormHighlight, SchemeSelHighlight, SchemeLast }; /* color schemes */
...
drawhighlights(struct item *item, int x, int y, int maxw)
{
	...
	drw_setscheme(drw, scheme[item == sel ? SchemeSelHighlight : ((item->left == sel || item->right == sel) ? SchemeMidHighlight : SchemeNormHighlight)]);
	strcpy(tokens, text);
